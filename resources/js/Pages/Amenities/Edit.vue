        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h1 class="text-3xl font-bold text-gray-900">Edit Amenity</h1>
                        <p class="mt-2 text-gray-600">Update the amenity information</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Amenity Information</h2>
                    <p class="text-sm text-gray-600 mt-1">Update the details below to modify the amenity</p>
                </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input v-model="form.name" type="text" 
                                ...
                                placeholder="e.g., Air Conditioning, Kitchen, Free WiFi"
                                required />
                        ...
                        <div>
                            ...
                            <input v-model="form.icon_name" type="text" 
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                placeholder="e.g., wifi, kitchen, parking (optional)" />
                            <p class="mt-1 text-sm text-gray-500">Optional: Specify an icon name for this amenity</p>
...
const form = useForm({
    ...
    icon_name: props.amenity.icon_name || ''
})

const submit = () => {
    form.put(route('amenities.update', props.amenity.uuid))
}
</script>
