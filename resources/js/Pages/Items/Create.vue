        ...
        <div class="p-4 mt-8">
            <div class="bg-white border-4 border-black max-w-6xl mx-auto">
                        ...
                        <div v-show="activeTab === 'details'" class="space-y-4">
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select v-model="form.item_type_id" class="w-full border-2 border-black p-2"
                                        required>
                            ...
                            <div>
                                ...
                                <textarea v-model="form.description" class="w-full border-2 border-black p-2 h-24"
                                    required></textarea>
                ...
                <div class="flex justify-end space-x-4 p-4">
                    ...
                    <button @click="nextTab" class="bg-gray-300 border-2 border-black px-6 py-2 hover:bg-gray-400"
