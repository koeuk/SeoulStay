        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600">Create a new property listing for Seoul Stay</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Fill in the details below to create your property listing</p>
                </div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div v-show="activeTab === 'amenities'" class="space-y-6">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mb-6">Select all amenities that are available in your property</p>
                            </div>
                        ...
                        <div v-show="activeTab === 'attractions'" class="space-y-6">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mb-6">Specify the distance and travel time to nearby attractions</p>
                            </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button @click="submit"
                            ...
                            {{ activeTab === 'attractions' ? 'Create Property' : 'Save & Continue' }}
                        </button>
                    </div>
                </div>
            </div>
